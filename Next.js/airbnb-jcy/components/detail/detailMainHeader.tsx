...
function DetailMainHeader({ hosting }: { hosting: HostingData }) {
  return (
    <Box id="title">
      <Box>
          <Typography variant="h3">{hosting.title}</Typography>
        </Box>
        <Box sx={{display:"flex", flexDirection:"row", justifyContent:"space-between"}}>
          <Box sx={{display:"flex", flexDirection:"row"}}>
            ...
            <Typography variant="subtitle1" sx={{textDecorationLine:"underline", ml:1}}>{hosting.location.state}, {hosting.location.city}</Typography>
          </Box>
          <Box sx={{display:"flex", flexDirection:"row"}}>
