...
const movies = [
    { id: "mv01", name: "토르 - 러브 앤 썬더", img: "/static/85999_320.jpg", reserve: ["1-1"] },
    { id: "mv02", name: "범죄도시 2", img: "/static/85813_320.jpg", reserve: ["2-1", "3-1"] },
    { id: "mv03", name: "탑건 - 매버릭", img: "/static/82120_320.jpg", reserve: ["4-1", "4-2"] },
    { id: "mv04", name: "헤어질 결심", img: "/static/85852_320.jpg", reserve: ["1-1"] },
];
...
app.use("/static", express.static(path.join(__dirname, "static")));    // static resource handle
